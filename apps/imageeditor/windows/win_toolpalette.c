...
static const toolbar_item_t k_tools[] = {
  {.type = TOOLBAR_ITEM_BUTTON, .ident = ID_TOOL_SELECT, .icon = "square-dashed", .tooltip = "Select"},
  {.type = TOOLBAR_ITEM_BUTTON, .ident = ID_TOOL_MOVE, .icon = "ruler-arrows", .tooltip = "Move"},
  {.type = TOOLBAR_ITEM_BUTTON, .ident = ID_TOOL_MAGIC_WAND, .icon = "magic-wand", .tooltip = "Magic Wand"},
  {.type = TOOLBAR_ITEM_BUTTON, .ident = ID_TOOL_CROP, .icon = "crop", .tooltip = "Crop"},
  {.type = TOOLBAR_ITEM_BUTTON, .ident = ID_TOOL_HAND, .icon = "drag-hand-gesture", .tooltip = "Hand"},
  {.type = TOOLBAR_ITEM_BUTTON, .ident = ID_TOOL_EYEDROPPER, .icon = "color-picker", .tooltip = "Eyedropper"},
  {.type = TOOLBAR_ITEM_BUTTON, .ident = ID_TOOL_ZOOM, .icon = "zoom-in", .tooltip = "Zoom"},
  {.type = TOOLBAR_ITEM_BUTTON, .ident = ID_TOOL_PENCIL, .icon = "edit-pencil", .tooltip = "Pencil"},
  {.type = TOOLBAR_ITEM_BUTTON, .ident = ID_TOOL_BRUSH, .icon = "design-nib", .tooltip = "Brush"},
  {.type = TOOLBAR_ITEM_BUTTON, .ident = ID_TOOL_SPRAY, .icon = "droplet-half", .tooltip = "Spray"},
  {.type = TOOLBAR_ITEM_BUTTON, .ident = ID_TOOL_FILL, .icon = "fill-color", .tooltip = "Fill"},
  {.type = TOOLBAR_ITEM_BUTTON, .ident = ID_TOOL_ERASER, .icon = "erase", .tooltip = "Eraser"},
  {.type = TOOLBAR_ITEM_BUTTON, .ident = ID_TOOL_LINE, .icon = "minus", .tooltip = "Line"},
  {.type = TOOLBAR_ITEM_BUTTON, .ident = ID_TOOL_TEXT, .icon = "text", .tooltip = "Text"},
  {.type = TOOLBAR_ITEM_BUTTON, .ident = ID_TOOL_RECT, .icon = "square", .tooltip = "Rect"},
  {.type = TOOLBAR_ITEM_BUTTON, .ident = ID_TOOL_ELLIPSE, .icon = "circle", .tooltip = "Ellipse"},
  {.type = TOOLBAR_ITEM_BUTTON, .ident = ID_TOOL_ROUNDED_RECT, .icon = "square", .tooltip = "Rounded Rect"},
  {.type = TOOLBAR_ITEM_BUTTON, .ident = ID_TOOL_POLYGON, .icon = "triangle", .tooltip = "Polygon"},
  {.type = TOOLBAR_ITEM_BUTTON, .ident = ID_TOOL_MAGNIFIER, .icon = "zoom-out", .tooltip = "Magnifier"},
