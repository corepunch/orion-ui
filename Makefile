...
# Generated amalgamated source for library build (single translation unit)
LIB_AMALGAMATED_SRC = $(LIB_DIR)/orion_amalgamated.c
...
$(LIB_AMALGAMATED_SRC): $(LIB_SRCS) | $(LIB_DIR)
	@echo "Generating amalgamated library source: $@"
	@{ \
...
$(STATIC_LIB): $(LIB_AMALGAMATED_SRC) | $(LIB_DIR)
	@echo "Creating static library: $@"
	@tmp_obj="$(LIB_DIR)/orion_static_tmp.objtmp"; \
	$(CC) $(CFLAGS) -c $(LIB_AMALGAMATED_SRC) -o "$$tmp_obj"; \
	$(AR) rcs $@ "$$tmp_obj"; \
	rm -f "$$tmp_obj"

$(SHARED_LIB): $(LIB_AMALGAMATED_SRC) | $(LIB_DIR)
	@echo "Creating shared library: $@"
	$(CC) $(CFLAGS) $(LIB_FLAGS) -o $@ $< $(LDFLAGS) $(LIBS)
...
$(TEST_ENV_BINS): $(BIN_DIR)/test_%$(EXE_EXT): $(TEST_DIR)/%.c $(TEST_DIR)/test_env.c $(STATIC_LIB) | $(BIN_DIR)
