...
// Returns a copy of frame_rect centered within the owner window's frame, or
// centered on screen when owner is NULL. The input rect is treated as a full
// window-frame rect (top-left of title bar, full width/height), not a client
// rect. The result is clamped to the visible screen bounds.
