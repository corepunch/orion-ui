...
static const accel_t kAccelEntries[] = {
  ...
  { FCONTROL|FVIRTKEY, SDL_SCANCODE_EQUALS, ID_VIEW_ZOOM_IN  },
  { FCONTROL|FSHIFT|FVIRTKEY, SDL_SCANCODE_EQUALS, ID_VIEW_ZOOM_IN  },
  { FCONTROL|FVIRTKEY, SDL_SCANCODE_MINUS,  ID_VIEW_ZOOM_OUT },
