...
static const fe_component_desc_t k_components[] = {
  ...
  },
  {
    ...
    .name_prefix = "IDC_EDT",
    .toolbox_ident = 203,
    .toolbox_icon = sysicon_text_field,
    .default_size = {121, 20},
    .capabilities = FE_COMPONENT_PLACEABLE | FE_COMPONENT_SHOW_TOOLBOX,
    .proc = win_textedit,
  },
  {
    ...
    .name_prefix = "IDC_LST",
    .toolbox_ident = 209,
    .toolbox_icon = sysicon_text_bullets,
    .default_size = {121, 60},
    .capabilities = FE_COMPONENT_PLACEABLE | FE_COMPONENT_SHOW_TOOLBOX,
    .proc = win_list,
  },
  {
    ...
    .name_prefix = "IDC_CMB",
    .toolbox_ident = 208,
    .toolbox_icon = sysicon_window_compact_off,
    .default_size = {121, 20},
    .capabilities = FE_COMPONENT_PLACEABLE | FE_COMPONENT_SHOW_TOOLBOX,
    .proc = win_combobox,
  },
  {
    ...
    .name_prefix = "IDC_SLD",
    .toolbox_ident = 210,
    .toolbox_icon = sysicon_flip_horizontal,
    .default_size = {121, 17},
    .capabilities = FE_COMPONENT_PLACEABLE | FE_COMPONENT_SHOW_TOOLBOX,
    .proc = win_slider,
  },
