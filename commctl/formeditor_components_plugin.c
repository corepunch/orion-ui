...
static const fe_component_desc_t k_components[] = {
  {
    ...
    .name_prefix = "IDC_BTN",
    .toolbox_ident = 205,
    .toolbox_icon = FUGUE_ICON_UI_BUTTON,
    .default_size = {75, 23},
  ...
  },
  {
    ...
    .name_prefix = "IDC_CHK",
    .toolbox_ident = 206,
    .toolbox_icon = FUGUE_ICON_UI_CHECK_BOX,
    .default_size = {97, 17},
    .capabilities = FE_COMPONENT_PLACEABLE | FE_COMPONENT_SHOW_TOOLBOX,
    .proc = win_checkbox,
  },
  {
    ...
    .name_prefix = "IDC_LBL",
    .toolbox_ident = 202,
    .toolbox_icon = FUGUE_ICON_PENCIL_FIELD,
    .default_size = {65, 13},
    .capabilities = FE_COMPONENT_PLACEABLE | FE_COMPONENT_SHOW_TOOLBOX,
    .proc = win_label,
  },
  {
    ...
    .name_prefix = "IDC_EDT",
    .toolbox_ident = 203,
    .toolbox_icon = FUGUE_ICON_UI_TEXT_FIELD,
    .default_size = {121, 20},
    .capabilities = FE_COMPONENT_PLACEABLE | FE_COMPONENT_SHOW_TOOLBOX,
    .proc = win_textedit,
  },
  {
    ...
    .name_prefix = "IDC_LST",
    .toolbox_ident = 209,
    .toolbox_icon = FUGUE_ICON_UI_LIST_BOX,
    .default_size = {121, 60},
    .capabilities = FE_COMPONENT_PLACEABLE | FE_COMPONENT_SHOW_TOOLBOX,
    .proc = win_list,
  },
  {
    ...
    .name_prefix = "IDC_CMB",
    .toolbox_ident = 208,
    .toolbox_icon = FUGUE_ICON_UI_COMBO_BOX,
    .default_size = {121, 20},
    .capabilities = FE_COMPONENT_PLACEABLE | FE_COMPONENT_SHOW_TOOLBOX,
    .proc = win_combobox,
  },
  {
    ...
    .name_prefix = "IDC_SLD",
    .toolbox_ident = 210,
    .toolbox_icon = FUGUE_ICON_UI_SLIDER_100,
    .default_size = {121, 17},
    .capabilities = FE_COMPONENT_PLACEABLE | FE_COMPONENT_SHOW_TOOLBOX,
    .proc = win_slider,
  },
  ...
  },
  {
    ...
    .name_prefix = "IDC_RVW",
    .toolbox_ident = 212,
    .toolbox_icon = FUGUE_ICON_APPLICATION_DETAIL,
  ...
  },
  {
    ...
    .name_prefix = "IDC_SPC",
    .toolbox_ident = 213,
    .toolbox_icon = FUGUE_ICON_LAYOUT_JOIN,
    .default_size = {80, 40},
